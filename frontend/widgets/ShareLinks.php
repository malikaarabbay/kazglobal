...
{
	/**
	 * Constants representing each social net
	 */
	...
	const SOCIAL_MAILRU = 7;
	const SOCIAL_ODNOKLASSNIKI = 8;
	 ...
	 * @var string
	 */
	public $linkSelector = '.share-social a';
	/**
	...
	public $shareUrlMap = [
		...
		self::SOCIAL_MAILRU => 'http://connect.mail.ru/share?url={url}',
		self::SOCIAL_ODNOKLASSNIKI => 'http://connect.ok.ru/dk?st.cmd=WidgetSharePreview&st.shareUrl={url}',
	];
